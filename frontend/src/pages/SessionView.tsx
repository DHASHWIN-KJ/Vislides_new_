        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (sessionRes.success) {
                    ...
                    // Self-healing: Open whiteboard on any activity for students
                    socketService.onWhiteboardDraw(() => {
                        if (!isTeacher) setShowWhiteboard(true);
                    });
                    socketService.onWhiteboardClear(() => {
                        if (!isTeacher) setShowWhiteboard(true);
                    });
                    socketService.onWhiteboardPDF(() => {
                        if (!isTeacher) setShowWhiteboard(true);
                    });
        ...
        const html = `
            ...
            <head>
                ...
                <style>
                    ...
                    .header h1 { margin: 0; color: #f59e0b; font-size: 24px; }
                    ...
                    .ai-label { font-size: 11px; font-weight: 800; color: #f59e0b; margin-bottom: 4px; display: block; text-transform: uppercase; }
        ...
        >
            ...
            >
                ...
                <section style={{
                    ...
                    <div style={{ maxWidth: '800px', width: '100%', margin: '0 auto 2rem auto', position: 'relative' }}>
                        {user?.role?.toLowerCase() === 'student' && code && (
                            <StudentNotepad sessionCode={code} />
                        )}
                    ...
                    <div style={{
                        ...
                        {selectedQuestion ? (
                            ...
                            <div style={{ textAlign: 'center', opacity: 0.5, marginTop: '2rem' }}>
                                ...
                                <p style={{ fontSize: '1.2rem', color: 'var(--color-text-muted)' }}>Class is live! Questions will appear below.</p>
                            </div>
                        )}
                    </div>

                    {/* New Core Feature: Horizontal Glassmorphic Question Carousel - TEACHER ONLY */}
                    {isTeacher && (
                        <div style={{
                            marginTop: 'auto',
                            paddingTop: '2rem',
                            ...
                            <h4 style={{ fontSize: '1rem', margin: '0 0 0.5rem 1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                <span style={{ color: 'var(--color-primary)' }}>💬</span> Live Questions Queue 
                                <span style={{ background: 'rgba(55,88,249,0.1)', color: 'var(--color-primary)', padding: '0.1rem 0.5rem', borderRadius: '1rem', fontSize: '0.8rem' }}>{questions.length}</span>
                            </h4>
                            <div style={{
                                display: 'flex',
                                gap: '1rem',
                                ...
                                {questions.length === 0 ? (
                                    <div style={{ padding: '2rem', textAlign: 'center', width: '100%', color: 'var(--color-text-muted)', border: '1px dashed rgba(0,0,0,0.1)', borderRadius: '1rem' }}>
                                    ...
                                    sortedQuestions.map((q) => (
                                        <div
                                            ...
                                            style={{
                                                minWidth: '280px',
                                                maxWidth: '280px',
                                                background: selectedQuestionId === q._id ? 'var(--color-primary)' : 'var(--color-surface)',
                                                color: selectedQuestionId === q._id ? '#ffffff' : 'var(--color-text)',
                                                borderRadius: 'var(--radius-xl)',
                                                padding: '1.25rem',
                                                cursor: 'pointer',
                                                boxShadow: selectedQuestionId === q._id ? 'var(--shadow-lg)' : 'var(--shadow-sm)',
                                                border: '1px solid',
                                                borderColor: selectedQuestionId === q._id ? 'var(--color-primary)' : 'var(--color-bg-tertiary)',
                                        ...
                                        >
                                            <div style={{ fontSize: '0.75rem', opacity: 0.8, marginBottom: '0.5rem', display: 'flex', justifyContent: 'space-between' }}>
                                                <span>{q.user?.name}</span>
                                                <div style={{ display: 'flex', gap: '0.2rem' }}>
                                                    {q.isPinned && <span title="Pinned">📌</span>}
                                                    {q.teacherAnswer && <span title="Answered">✅</span>}
                                                </div>
                                            </div>
                                            <div style={{ fontSize: '1rem', fontWeight: '500', lineHeight: '1.4', overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical' }}>
                                                {q.content}
                                            </div>
                                        </div>
                                    ))
                ...
                <aside style={{
                    ...
                    <div style={{ flex: 1, overflowY: 'auto', paddingRight: '0.5rem' }}>
                        <div className="bento-box" style={{ marginBottom: '1.5rem' }}>
                        ...
                        <div className="bento-box" style={{ padding: '1rem', marginTop: '1.5rem' }}>
            ...
            {/* Custom End Session Modal */}
            {
                showEndModal && (
                    <div style={{
                        ...
                        <div className="bento-box anim-slide-up" style={{
                            maxWidth: '400px',
                            width: '100%',
                            padding: '2rem',
                            textAlign: 'center',
                            ...
                            <h3 style={{ fontSize: '1.5rem', marginBottom: '0.75rem', color: '#ffffff' }}>End Session?</h3>
            ...
            {/* Pulse Check Modal for Students */}
            {
                pulseCheckActive && user?.role?.toLowerCase() === 'student' && (
                    <div style={{
                        ...
                        <div className="bento-box anim-scale-up" style={{
                            width: '300px',
                            padding: '2rem',
                            textAlign: 'center',
                            background: 'rgba(30, 41, 59, 0.95)',
